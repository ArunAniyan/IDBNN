...
class ObjectDetectorTrainer:
    ...
    def train_epoch(self, epoch: int) -> Dict[str, float]:
        ...
        for images, targets in progress_bar:
            ...
            if (
                "class_logits" in outputs
                and hasattr(self.model, "use_dbpn")
                and self.model.use_dbpn
            ):
            ...
            progress_bar.set_postfix(
                {
                    ...
                    "dbpn": dbpn_loss_total / len(progress_bar)
                    if hasattr(self, "dbpn_loss")
                    else 0.0,
                }
            )
            ...
            return {
                ...
                "dbpn_loss": dbpn_loss_total / len(self.train_loader)
                if hasattr(self, "dbpn_loss")
                else 0.0,
            }
        # ... rest of the method ...
